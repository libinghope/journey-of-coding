...
permalink: "8.10"
---
今天以开源微服务框架 Dubbo 为例来给你具体讲解前面章节所说的组件。

### 服务发布与引用

Dubbo 框架主要是使用 XML 配置方式来实现的，接下来通过具体实例，来讲明 Dubbo 框架服务发布与引用是如何实现的。
...
前面讲过在服务调用的过程中，通常把服务消费者叫作客户端，服务提供者叫作服务端，发起一次服务调用需要解决四个问题：
...
![Dubbo协议头](https://pic.downk.cc/item/5ebea381c2a9a83be5e7e645.jpg)
...
如下图中的 Invoker 是对服务提供者节点的抽象，Invoker 封装了服务提供者的地址以及接口信息。

![Invoker](https://pic.downk.cc/item/5ebea3f9c2a9a83be5e861c3.jpg)
...
上面我讲的是 Dubbo 下每个基本组件的实现方式，那么 Dubbo 框架下，一次服务调用的流程是什么样的呢？如下这张图所示

首先来解释微服务架构中各个组件分别对应到上面这张图中是如何实现。
...
* 同时通过 Filter 层拦截调用，实现客户端的监控统计。最后在 Protocol 层，封装成 Dubbo RPC 请求，发给服务端节点。
